...
//define valores defaul para erros com os codigos listados caso a requisição não retorne uma mensagem
...
export default class ApiService {
  ...
  // alterna para retorno de mock para cenários de teste
